...
const SubmitButton = () => {
    ...
    return (
        <button
            type='submit'
            className='bg-[linear-gradient(120deg,#8fe0ff,#6f9bff)] text-black w-full rounded-full mt-3 py-2  hover:opacity-90 transition-opacity cursor-pointer'
            disabled={pending}>
            {pending ? "注册中..." : "注册"}
        </button>
    )
...
export const Register = () => {
    ...
    return (
        <div className='h-screen w-full flex items-center justify-center'>
            {/* 注册框 */}
            <div
                className='backgroundStyle flex flex-col gap-7 items-center justify-center  h-11/20 w-1/4 min-h-[450px] min-w-[350px]'
                >
                {/* 标题 */}
